...
const storyBranch = [
  ...
  },
  {
    id: 2,
    title: "ボイジャーX　「ルート1」",
    text: '<p>余計なことを考えるのをやめ、大切なことに集中した。目の前にいる人の命を救うこと。どんな質問であれ、彼から答えが聞けるかもしれない。そして、私は血清を注入するための引き金を引いた。<br /> しばらく待っても、スクリーンのバイタルに改善は見られず、弱々しく、死と生の狭間で浮遊している状態でした。<br /> 「本当に......やったのか？」 アランが戸惑いながら聞いた。<br /> 薬が本当に効いたのかどうか、私たち二人とも知らなかった。私はただ、言われたことをやっただけです。私も彼と同じように混乱しました。<br /> 「彼にはもっと必要なものがあると思う？」 ローエンが提案した。<br /> サラがコンピュータの画面を見ながら、「&quot;あれ &quot;は一瞬で効くはずなんだ」と言い、研究データを読み上げた。確かにそうかもしれない。でも、これだけ長い間死んでいるのだから、もっと投与量が必要なのではないか、という結論に至った。<br /> 私は皆を見回し、これから行うことを告げた。私は、より良い結果を期待して、残りの血清を彼に注射しました。カプセルの中でぐっすり眠っているようだった。<br /> 「もったいない......」と、心の中で思った。失意を胸に抱きながらも、ほとんどの人が「続けなければならない」と思っていた。いずれ薬が効くことを祈るしかない。ボイジャーX号内部の他の場所を探して、もっと手がかりを見つけ、データを収集しに行くしかないのだ。<br /> サラがデータをコピーし終わると、私たちは探検を続けるために部屋の外に出た。開けられたドアの外から、アランはカプセルの前に立って、眠っている男の顔を見ていた。その表情には、自分の気持ちを抑えようとする難しい感情が表れていた。<br /> 絶望感だろうか。悲しみか？後悔かな？確かなことは分からないが、私たちは移動を続けなければならないので、彼が思考から戻り、ポッドから歩き出すと、私は彼を呼び止めた。もう一度、部屋から離れると、アランは少し落ち込んだ様子で後ろを歩いていた。<br /> ローエンが聞いたという音も、自分が感じたと思った濡れた表面も、サラが感じたと言った冷たい感触も。そのどれもがもう起こらず、すべてが元通りになったような気がした。私たちはただ歩き続け、虚無の中を歩く私たちの足音だけが響いている。<br /> 「待てよ...足音？」 ローウェンとサラが横目で見ているので、私はとっさに足を止めながら、声に出して考えた。ローウェンとサラが横目で見ているので、私は思わず足を止めた。 &nbsp;<br /> 私たちが立ち止まると、エコーも止まりましたが、私の体は急に冷たくなりました。それは恐怖からではなく、外からのものでした。廊下の明かりが薄暗くなったので、後ろを歩いていたアランを確認するために奥の方を見た。彼はもう私たちの後ろではありませんでした。金属音がして、ローウェンもサラも驚いたのか、少し身震いした。<br /> 「アラン...？」</p> ',
    routes: [
      {
        text: 'バッドエンド： もう一度読む？',
        nextText: -1
